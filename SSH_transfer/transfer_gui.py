...
def demo():
    root = Tkinter.Tk()
    wizard = Wizard(npages=7)
    wizard.master.minsize(600, 550)
    page1 = ttk.Label(wizard.page_container(0), text='Page 1')
    page2 = ttk.Label(wizard.page_container(1), text='Page 2')
    page3 = ttk.Label(wizard.page_container(2), text='Page 3')
    page4 = ttk.Label(wizard.page_container(3), text='Page 4')
    page5 = ttk.Label(wizard.page_container(4), text='Page 5')
    page6 = ttk.Label(wizard.page_container(5), text='Page 6')
    page7 = ttk.Label(wizard.page_container(6), text='Page 7')
    wizard.add_page_body(page1)
    wizard.add_page_body(page2)
    wizard.add_page_body(page3)
    wizard.add_page_body(page4)
    wizard.add_page_body(page5)
    wizard.add_page_body(page6)
    wizard.add_page_body(page7)
